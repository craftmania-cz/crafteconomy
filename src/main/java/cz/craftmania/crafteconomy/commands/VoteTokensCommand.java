...
public class VoteTokensCommand {
    ...
    public static void register() {
        ...
        CommandAPI.getInstance().register("votetokens", new String[] {"vt"}, null, (sender, args) -> {
            ...
            p.sendMessage("§e§l[*] §eAktuálně máš " + tokens + " VoteTokens.");
        });
            ...
            switch (subCommand.toLowerCase()) {
                case "add": case "give":
                    ...
                    if (p != null) {
                        ...
                        sender.sendMessage("§e§l[*] §ePřidal jsi hráči §f" + playerName + " §7- §b" + tokensToAdd + " VT.");
                    } else {
                ...
                case "take": case "remove":
                    ...
                    if (player2 == null) {
                        ...
                        sender.sendMessage("§e§l[*] §eOdebral jsi hráči §f" + playerName2 + " §7- §d" + tokensToTake + " VT.");
                        break;
                    }
